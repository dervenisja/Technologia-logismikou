...
public class Main {
    ...
    private static void hostMenu() {
        ...
        while (inHostMenu) {
            ...
            System.out.println("1. Δημιουργία Νέου Πάρτι ");
            System.out.println("2. Διαχείριση / Τροποποίηση Playlist ");
            System.out.println("3. Προβολή & Έγκριση Αιτημάτων Τραγουδιών ");
            System.out.println("4. Ενεργοποίηση Closing Mode ");
            System.out.println("5. Παράταση Διάρκειας Πάρτι ");
            System.out.println("6. Διαχείριση Συνδρομής Host ");
            System.out.println("7. Συγχρονισμός Φωτισμού - Smart Lighting ");
            System.out.println("8. Ρυθμίσεις Ήχου & EQ (Audio Settings)");
            ...
            switch (action) {
                ...
                case 8: audioSettingsFlow(selectedHost); break;
                case 0: inHostMenu = false; break;
            }
        }
    }

    //  μέθοδος για την επιλογή πάρτι
    ...
    private static void extendDurationFlow(PartyHost host) {
        ...
        if (party != null) {
            ...
            System.out.println("⏰ [Live Update] Η νέα ώρα λήξης του πάρτι είναι: " + party.getEndTime());
        }
    }
    ...
    private static void audioSettingsFlow(PartyHost host) {
        Party party = selectHostParty(host);
        if (party != null) {
            System.out.println("\n--- 🎛️ Audio Mixer: " + party.getTheme() + " ---");
            System.out.println("Τρέχουσες ρυθμίσεις -> Ένταση: " + party.getVolume() + " | Μπάσα: " + party.getBass() + " | Πρίμα: " + party.getTreble());
            System.out.println("-----------------------------------------");

            System.out.println("Εισαγωγή νέων τιμών (0 έως 100):");
            int vol = getIntInput("Ένταση (Volume): ");
            int bass = getIntInput("Μπάσα (Bass): ");
            int treble = getIntInput("Πρίμα (Treble): ");

            // Κλήση του Controller (ο οποίος θα καλέσει τον Persistence)
    ...
    // 1.  μέθοδος μόνο για Είσοδο & Πληρωμή
